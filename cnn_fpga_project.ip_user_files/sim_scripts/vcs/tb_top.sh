...
#
# Script generated by Vivado on Thu Mar 12 10:49:36 +0530 2026
...
#
# Usage        : tb_top.sh
#                tb_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_top.sh [-reset_run]
#                tb_top.sh [-reset_log]
#                tb_top.sh [-help]
#
...
#                script (type 'tb_top.sh -help' for more information).
#
...
# script info
echo -e "tb_top.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../../OMPRAKASH/ M/cnn_fpga_project/cnn_fpga_project.srcs/sources_1/new/conv_engine.v" \
  "../../../../../OMPRAKASH/ M/cnn_fpga_project/cnn_fpga_project.srcs/sources_1/new/top.v" \
  "../../../../../OMPRAKASH/ M/cnn_fpga_project/cnn_fpga_project.srcs/sources_1/new/weight_memory.v" \
  "../../../../../OMPRAKASH/ M/cnn_fpga_project/cnn_fpga_project.srcs/sim_1/new/tb_top.v" \
...
reset_run()
{
  files_to_remove=(ucli.key tb_top_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tb_top_simv.daidir vcs_lib c.obj)
...
Usage: tb_top.sh [-step]\n\
Usage: tb_top.sh [-lib_map_path]\n\
Usage: tb_top.sh [-reset_run]\n\
Usage: tb_top.sh [-reset_log]\n\
Usage: tb_top.sh [-keep_index]\n\
